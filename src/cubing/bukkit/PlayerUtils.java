...
public class PlayerUtils {
    ...
    public static void sendTabHeaderFooter(PlayerConnection connection, String header, String footer) {
        connection.sendPacket(PacketWrapper.PacketPlayOutPlayerListHeaderFooter(header, footer));
    }
}
